...
(function($, document, window) {
    ...
    $.fn.userTimeout = function(opts) {
        ...
        var defaults = {
            ...
            modalBody: 'You\'re being timed out due to inactivity. Click OK to continue.' // Modal Body
        };
        ...
        var modal = function() {
            ...
            if (modalUI === 'bootstrap') {
                ...
                if (options.timer === true) {
                    footer = $('<div class="modal-footer"><button type="button" class="btn btn-primary" data-dismiss="modal">OK</button></div>');
                    countDown(seconds);
                } else {
                    footer = $('<div class="modal-footer"><button type="button" class="btn btn-primary" data-dismiss="modal">Ok</button></div>');
                }
